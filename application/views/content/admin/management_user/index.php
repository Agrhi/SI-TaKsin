            ...
            <table class="table" id="user">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn icon btn-primary updateuser" id="<?= $u->id; ?>" nama="<?= $u->nama; ?>" username="<?= $u->username; ?>" password="<?= $u->password; ?>" type="button" data-bs-toggle="modal" data-bs-target="#editdata"><i class="bi bi-arrow-clockwise"></i></button>
